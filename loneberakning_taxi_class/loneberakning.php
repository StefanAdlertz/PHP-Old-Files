...
<title>L&ouml;neber&auml;kning</title>
</head>
<body>
...
echo "<table class='tbl_r' border='0' cellpadding='2' cellspacing='0'>";
    ...
    echo"<tr>
        ...
        <td align='right' class='toptd'>Pass Nr</td>
        <td align='right' class='toptd'>Summa Inkört</td>
        <td align='right' class='toptd'>Redovisa</td>
...
echo "<table class='tbl_lr' border='0' cellpadding='2' cellspacing='0'>";

    print_loneberakning($manad,$opendb);
    print_button();
